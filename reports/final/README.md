...
|-----------|------|--------|
| `atari_reversed/` | Five-game Atari sequence, reversed order: ours vs CLEAR vs CKA-RL vs CompoNet | **in flight** — ours 3/5, CKA-RL 3/5, CompoNet 2/5, CLEAR complete but pre-fix |
